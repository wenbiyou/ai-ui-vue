...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/wenbiyou/ai-ui-vue' }],
    ...
    sidebar: {
      '/guide/': [
        ...
        {
          text: '定制',
          items: [{ text: '主题定制', link: '/guide/theme-customization' }],
        },
        {
          text: '示例',
          items: [{ text: 'SSE 流式响应', link: '/guide/sse-demo' }],
        },
        {
          text: '适配',
          items: [{ text: '移动端适配', link: '/guide/mobile' }],
        },
        {
          text: '性能',
          items: [{ text: '性能对比', link: '/guide/performance' }],
        },
      ],
      '/components/': [
        {
